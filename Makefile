...
init: init.cc malloc.o scheduler.o user.o $(USER_SO) allocators.h
...
scheduler.o: scheduler.cc shared_data.h allocators.h
	g++ $(CXX_FLAGS) -fPIC -c $< -o $@

model.o: model.cc shared_data.h allocators.h
	g++ $(CXX_FLAGS) -fPIC -c $< -o $@

user.o: user.cc shared_data.h allocators.h
	g++ $(CXX_FLAGS) -fPIC -c $< -o $@
